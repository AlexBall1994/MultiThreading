...
public class Simulation {
	...
	public static List<SimulationEvent> runSimulation(
		...
		cust.setMaxCapacity(numTables);


		// Start up machines
		Machine m = new Machine(null, null, machineCapacity);
		Cook co = new Cook(null);
		co.logMachine();
	...
	public static void main(String args[]) throws InterruptedException {
		...
		Validate v = new Validate(numCustomers, numCooks, numTables, machineCapacity);
